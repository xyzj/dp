...
func testTmldata() {
	...
	s := strings.Split("7e-19-fe-00-b7-68-36-80-02-00-00-00-68-91-08-33-33-34-33-3c-63-58-3b-20-16-81-8f", "-")
	ss := make([]byte, len(s))
	for k, v := range s {
...
func main() {
	s := gopsu.String2Bytes("68-36-80-02-00-00-00-68-91-08-33-33-34-33-3c-63-58-3b-20-16", "-")
	println(gopsu.CheckLrc(s))
