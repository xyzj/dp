...
func testTmldataNB() {
	...
	s = strings.Split("68-01-00-00-00-00-00-68-9c-1c-7d-18-01-00-d3-51-78-17-1f-2c-55-03-32-00-fa-00-fa-00-fa-00-83-01-00-00-00-00-72-1d-a8-16", "-")
	// s = strings.Split("68 19 00 19 00 68 A8 01 01 42 16 00 00 0A 61 00 00 04 01 00 1D 3A D0 07 00 71 35 54 0B DC 0D 8E 16", " ")
...
func tmlshv1data() {
	...
	s := "68 44 00 44 00 68 14 20 02 00 00 00 00 00 89 67 00 00 01 00 35 30 53 54 53 54 57 4A 33 30 30 36 30 2E 37 30 15 12 15 30 30 30 30 30 30 30 30 30 30 30 31 2E 30 35 31 2E 37 30 53 53 43 31 36 34 33 20 12 08 14 00 03 09 03 15 A3 89 16"
	dp.ParseTml(gopsu.String2Bytes(s, " "))
}
func main() {
	println(gopsu.Bytes2String(gopsu.Float642BcdBytes(float64(102220), "%016.0f"), "-"))
	//tmlshv1data()
