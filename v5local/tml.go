...
// 恒杰门禁
func dataHJLock(d []byte, tra byte, parentID int64, ip *int64, portlocal *int) (lstf []*Fwd) {
	var f = &Fwd{
	...
	svrmsg := initMsgCtl(fmt.Sprintf("hj.lock.%02x00", cmd), f.Addr, *ip, 1, tra, cid, portlocal)
	...
	case 0x82: // 读取状态
		...
		svrmsg.WlstTml.HjLock_8200.LockoffDelay = int32(gopsu.Bytes2Uint64(d[8:10], true))
		...
		svrmsg.WlstTml.HjLock_8200.Cards = int32(gopsu.Bytes2Int64(d[18:20], true))
		svrmsg.WlstTml.HjLock_8200.HardwareVer = gopsu.Bytes2Uint64(d[20:24], true)
		svrmsg.WlstTml.HjLock_8200.LastCard = gopsu.Bytes2Uint64(d[24:28], true)
