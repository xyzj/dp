		...
		case 2:
			...
			case 2, 5, 6, 7:
					...
					case "rtu": // 终端
						...
						case "3100": // 设置周设置1-3
							for i := 0; i < 7; i++ {
								...
								d.WriteByte(gopsu.Int82Bcd(m))
								// 市付自付
								h = gopsu.String2Int8("25", 10)
								m = gopsu.String2Int8("00", 10)
								d.WriteByte(gopsu.Int82Bcd(h))
								d.WriteByte(gopsu.Int82Bcd(m))
								h = gopsu.String2Int8("25", 10)
								m = gopsu.String2Int8("00", 10)
				...
				case "hj":
					...
					case "0600": // 添加卡
						d.Write(gopsu.Uint642Bytes(pb2data.WlstTml.HjLock_0600.Card, true)[4:])
					case "0700": // 删除卡
						d.Write(gopsu.Uint642Bytes(pb2data.WlstTml.HjLock_0700.Card, true)[4:])
					case "0800": // 设置管理卡
						d.Write(gopsu.Uint642Bytes(pb2data.WlstTml.HjLock_0800.MasterCard1, true)[4:])
						d.Write(gopsu.Uint642Bytes(pb2data.WlstTml.HjLock_0800.MasterCard2, true)[4:])
					case "0900": // 重启
					case "0a00": // 恢复出厂
					case "0b00": // 读取一个卡号(不做)
					case "0c00": // 设置开锁时间
