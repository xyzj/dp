...
func (dp *DataProcessor) dataHJLock(d []byte, tra byte, parentID int64) (lstf []*Fwd) {
	...
	case 0x82: // 读取状态
		...
		svrmsg.WlstTml.HjLock_8200.MasterCard1 = gopsu.Bytes2Uint64(d[10:14], false)
		svrmsg.WlstTml.HjLock_8200.MasterCard2 = gopsu.Bytes2Uint64(d[14:18], false)
		svrmsg.WlstTml.HjLock_8200.Cards = int32(gopsu.Bytes2Int64(d[18:20], false))
		svrmsg.WlstTml.HjLock_8200.HardwareVer = gopsu.Bytes2Uint64(d[20:23], false)
